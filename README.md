...
В приложении используется событийно-ориентированный подход. Данный класс реализует этот подход. Суть данного подхода заключается в том, чтобы в любом месте приложения можно было сообщить о каком-либо событии
